...
def detect(image_path='', label_path=''):
    ...
    image_result_path = os.path.join(main_path, 'media/image/CEIR/result/step2/image/')
    label_result_path = os.path.join(main_path, 'media/image/CEIR/result/step2/label/')
    output_path = image_result_path
    print(output_path)
    output_image_path = os.path.join(main_path, 'media/image/CEIR/result/step2/reshape/')
