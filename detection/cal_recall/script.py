...
def default_evaluation_params():
    ...
    return {
        ...
        'GT_SAMPLE_NAME_2_ID': 'X([0-9]+).txt',
        'DET_SAMPLE_NAME_2_ID': 'X([0-9]+).txt',
...
def evaluate_method(gtFilePath, submFilePath, evaluationParams):
    ...
    for resFile in gt:
        ...
        if resFile in subm and resFile:
        ...
        #     print('hmean: ', hmean)
        #     print('=======================================')
        #     low_recall_list.append(resFile)
    ...
    # print('len(low_recall_list): ', len(low_recall_list))
    # print(low_recall_list)
    return resDict;
